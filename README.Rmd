...
covariates <-  c(
  "gender","race","birthmonth","birthyear","SCHLURBN","GRDRANGE","GKENRMNT","GKFRLNCH","GKBUSED","GKWHITE")
...
user_formula <- as.formula(
  "g3tlangss ~ gender + race + birthmonth + birthyear + SCHLURBN + GRDRANGE + GKENRMNT + GKFRLNCH + GKBUSED + GKWHITE + treatment")
...
```{r cv_estimate, message = FALSE, echo=FALSE, out.width = '60%'}
# estimate ITR 
set.seed(2021)
fit_cv <- estimate_itr(
               treatment = treatment,
