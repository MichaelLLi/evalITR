...
(2023)](https://arxiv.org/abs/1905.05389) to estimate and evaluate ITR. Instead of specifying the `split_ratio` argument, 
...
```{r cv_estimate, message = FALSE, out.width = '50%'}
# evaluate ITR 
