...
Heterogeneous treatment effects that are estimated by causal machine learning models could be imprecise in many applications. This R package provides the following nonparametric statistical tests to evaluate whether if the machine learning algorithms are picking up real heterogeneity, instead of noise. 
